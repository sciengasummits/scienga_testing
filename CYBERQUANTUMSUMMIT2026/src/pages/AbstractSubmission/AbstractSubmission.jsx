...
const DEFAULT_DATES = [
    ...
    { month: 'JAN', day: '25', year: '2027', event: 'Abstract Submission Deadline', icon: 'Clock' },
    {
        month: 'DEC', day: '07', year: '2027',
        event: 'Conference Date',
        sub: 'December 07-09, 2027, Singapore',
        icon: 'Star',
    },
];
...
const AbstractSubmission = () => {
    ...
    useEffect(() => {
        fetchContent('importantDates')
            ...
            .catch(err => console.warn('[AbstractSubmission] Failed to fetch dates:', err?.message));
    }, []);
                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group">
                                    ...
                                    >
                                        ...
                                        <option value="quantum-computing">Quantum Computing Fundamentals</option>
                                        <option value="post-quantum-crypto">Post-Quantum Cryptography</option>
                                        <option value="qkd">Quantum Key Distribution (QKD)</option>
                                        <option value="cybersecurity-threats">Cybersecurity Threat Intelligence</option>
                                        <option value="ai-security">AI-Driven Security Analytics</option>
                                        <option value="quantum-safe-networks">Quantum-Safe Network Architectures</option>
                                        <option value="zero-trust">Zero Trust Security Framework</option>
                                        <option value="blockchain-security">Blockchain & Distributed Ledger Security</option>
                                        <option value="iot-security">IoT & Edge Computing Security</option>
                                        ...
                                        <option value="cloud-security">Cloud Security & Data Privacy</option>
                                    </select>
                                </div>
                            </div>
