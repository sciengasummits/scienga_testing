    ...
    return (
        <Link to={linkTo} className={`app-logo ${className}`} onClick={onClick}>
            <div className="logo-icon-container">
                <Shield size={28} strokeWidth={2.5} className="logo-icon-primary" />
                <div className="logo-icon-accent-wrapper">
                    <div className="logo-icon-accent">
                        <Atom size={12} fill="currentColor" strokeWidth={0} />
                    </div>
                </div>
            </div>
            <div className="logo-text-container">
                <span className="logo-text-main">CYBERQUANTUM<br></br>SUMMIT2026</span>
            </div>
        </Link>
    );
};
