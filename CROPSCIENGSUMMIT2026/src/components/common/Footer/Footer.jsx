                ...
                <div className="footer__top">
                    <div className="footer__col">
                        ...
                        <p className="footer__desc">
                            Global experts unite to shape the future of sustainable agriculture.
                            Discover ground-breaking technologies and connect with top agricultural professionals.
                        </p>
                    ...
                    <div className="footer__col">
                        ...
                        <ul className="footer__contact">
                            ...
                            <li>
                                <Mail size={18} />
                                <span>contact@cropscienceconf.com</span>
                            </li>
                            <li>
                                <Phone size={18} />
