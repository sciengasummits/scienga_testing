...
const sessionsData = [
    { title: "Precision Agriculture & Smart Farming", icon: Cpu },
    { title: "Crop Genetics & Plant Breeding", icon: Microscope },
    { title: "Sustainable Irrigation Systems", icon: Droplet },
    { title: "Soil Science & Fertility Management", icon: Leaf },
    { title: "Pest & Disease Management", icon: Bug },
    { title: "Agricultural Biotechnology", icon: FlaskConical },
    { title: "Climate-Resilient Crops", icon: Thermometer },
    { title: "Post-Harvest Technology & Storage", icon: Factory },
    { title: "Crop Physiology & Metabolism", icon: Sprout },
    { title: "Seed Technology & Production", icon: Wheat },
    { title: "Agricultural Machinery & Automation", icon: Tractor },
    { title: "Organic Farming Systems", icon: Leaf },
    { title: "Crop Protection & Integrated Pest Management", icon: ShieldCheck },
    { title: "Agricultural Data Analytics", icon: BarChart },
    { title: "Hydroponics & Vertical Farming", icon: Droplet },
    { title: "Crop Modeling & Simulation", icon: Cpu },
    { title: "Agricultural Policy & Economics", icon: Globe },
    { title: "Food Security & Nutrition", icon: Wheat },
    { title: "Sustainable Crop Production", icon: Recycle },
    { title: "Agricultural Extension & Education", icon: Lightbulb },
    { title: "Crop Improvement Technologies", icon: Microscope },
    { title: "Water Management in Agriculture", icon: Droplet },
    { title: "Agricultural Waste Management", icon: Recycle },
    { title: "Climate Change Impact on Crops", icon: CloudRain },
    { title: "Agroforestry Systems", icon: TreeDeciduous },
    { title: "Crop Quality & Safety", icon: ShieldCheck },
    { title: "Agricultural Robotics", icon: Tractor },
    { title: "Crop Diversification Strategies", icon: Sprout },
    { title: "Agricultural Innovation & Entrepreneurship", icon: Lightbulb },
    { title: "Future of Crop Science", icon: Sun },
];
                        ...
                        <div className="sessions-list-container">
                            <ul className="sessions-list-clean">
                                {displaySessions.map((session, index) => {
                                    const Icon = session.icon || Sprout;
                                    return (
