            ...
            <div className="container hero__container">
                <div className="hero__content">
                    ...
                    <p className="hero__desc">
                        Annual International Conference on Crop Science and Engineering, where global experts unite to shape
                        the future of sustainable agriculture. Discover ground-breaking technologies, connect with
                        top agricultural professionals, and explore solutions transforming crop production and food security.
                    </p>
