...
const Register = ({ isDiscounted = false }) => {
    ...
    // const standardEnd = new Date('2026-10-31');
    ...
    // Today is after Oct 31, 2026. Standard ended Oct 31, 2026. So OnSpot is active.
                        ...
                        <thead>
                            <tr>
                                ...
                                <th className={activePhase === 'standard' ? 'active-header-standard' : ''}>
                                    ...
                                    <span className="date">October 31, 2026</span>
                                ...
                                <th className={activePhase === 'onspot' ? 'active-header-onspot' : ''}>
                                    ...
                                    <span className="date">December 7, 2026</span>
