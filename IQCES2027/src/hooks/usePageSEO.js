...
const SITE_NAME = 'iqce2027';
const BASE_URL = 'https://iqce2027.com';
const DEFAULT_IMAGE = `${BASE_URL}/og-image.png`;
const DEFAULT_DESC =
    'INTERNATIONAL CONFERENCE ON iqce2027 THEORY AND TURBULENCE MECHANISM. December 14–16, 2026 · Outram, Singapore.';
    ...
    useEffect(() => {
        const apply = (dbData) => {
            ...
            const fullTitle = rawTitle
                ...
                : `${SITE_NAME} | INTERNATIONAL CONFERENCE ON iqce2027 THEORY AND TURBULENCE MECHANISM – Singapore`;
