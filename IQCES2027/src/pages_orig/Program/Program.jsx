...
const Program = () => {
    usePageSEO({
        ...
        description: 'iqce2027 conference program – keynote sessions, technical presentations, and workshops on iqce2027 Theory, Turbulence Mechanism, and CFD. Full schedule to be announced May 2026.',
        canonical: 'https://iqce2027.com/program',
    });
                ...
                <div className="container">
                    <div className="contact__form-wrapper" style={{ maxWidth: '600px', margin: '0 auto', background: 'var(--color-bg-light)', padding: '2rem', borderRadius: '15px' }}>
                        <div className="form-header text-center mb-4">
                            ...
                            <p>The comprehensive conference schedule will be revealed by May 2027. Fill the form to get notified directly.</p>
                        </div>
                        {isSubmitted ? (
