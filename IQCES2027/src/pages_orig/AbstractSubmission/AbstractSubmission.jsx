...
const AbstractSubmission = () => {
    ...
    const [templateUrl, setTemplateUrl] = useState('/pdfs/abstract-template.doc');
    ...
    useEffect(() => {
        fetchContent('hero').then(data => {
            if (data?.abstractTemplateUrl) setTemplateUrl(data.abstractTemplateUrl);
        }).catch(() => { });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // submitAbstract() in siteApi.js automatically adds conference: 'iqce2027'
                ...
                <div className="abstract-layout">
                    ...
                    <div className="abstract-col-left">
                        ...
                        <p className="abstract-intro">
                            ...
                            of your research.{' '}
                            <a href={resolveImageUrl(templateUrl)} target="_blank" rel="noreferrer" className="template-link">Download the Abstract Template</a>
                        </p>
