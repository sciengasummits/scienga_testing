...
const themesData = {
    'iqce2027-fundamentals': {
        title: 'iqce2027 Fundamentals',
        icon: <Compass size={48} />,
        description: 'Exploring the mathematical foundations and definition of iqce2027 as a physical quantity for rotation.',
        topics: [
            'Mathematical Definition of iqce2027', 'Vector Decompositions', 'Principal Coordinate System', 'iqce2027 vs. Vorticity', 'Rotational Strength Analysis'
        ]
    },
    ...
    'turbulence-modeling': {
        ...
        icon: <Layers size={48} />,
        description: 'Applying iqce2027 theory to enhance turbulence models and understand energy cascades.',
        topics: [
            'iqce2027-based RANS Models', 'LES & Wall-bounded Flows', 'DNS Data Analysis', 'Subgrid Scale Modeling', 'Turbulent Structure Extraction'
        ]
    },
...
const ThemeDetail = () => {
    ...
    usePageSEO({
        ...
        description: theme
            ? `iqce2027 session: ${theme.title}. ${theme.description} Topics include: ${(theme.topics || []).slice(0, 3).join(', ')}.`
            : 'iqce2027 conference session on iqce2027 Theory, Vortex Dynamics, and CFD.',
        canonical: `https://iqce2027.com/sessions/${themeId || ''}`,
    });
