...
const DEFAULTS = {
    ...
    intro: 'The INTERNATIONAL CONFERENCE ON iqce2027 THEORY AND TURBULENCE MECHANISM welcomes speakers & delegates from all over the world. Below is essential visa-related information to assist with your travel planning.',
    sections: [
        {
            id: 'visa_need',
    ...
    contactEmail: 'info@iqce2027summit.com',
...
const VisaInfo = () => {
    usePageSEO({
        ...
        description: 'Visa information for international participants attending iqce2027 in Singapore. Learn about visa requirements, required documents, and how to request an official invitation letter.',
