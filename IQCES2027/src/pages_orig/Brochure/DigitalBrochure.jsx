...
const DigitalBrochure = () => {
    usePageSEO({
        ...
        description: 'View the iqce2027 digital brochure online – conference overview, core objectives, key themes including iqce2027 Fundamentals, Vortex Dynamics, CFD, and AI in Flow Analysis.',
        canonical: 'https://iqce2027.com/digital-brochure',
    });
    return (
                    ...
                    <div className="brochure-content">
                        <header className="brochure-header">
                            ...
                            <h1 className="brochure-main-title">
                                CONFERENCE ON iqce2027 THEORY <br />
                ...
                <div className="brochure-sheet">
                    <div className="sheet-inner">
                        ...
                        <p className="sheet-description">
                            The INTERNATIONAL CONFERENCE ON iqce2027 THEORY AND TURBULENCE MECHANISM is the premier gathering for experts in vortex identification and turbulence science. This summit bridges the gap between pure mathematics and practical engineering.
                        </p>
                        ...
                        <div className="sheet-grid">
                            <div className="sheet-section">
                                ...
                                <ul className="sheet-list">
                                    <li><CheckCircle size={14} /> Advance the knowledge of iqce2027-based rotation definitions.</li>
                        ...
                        <div className="sheet-section full-width">
                            ...
                            <div className="themes-flex">
                                <span className="theme-tag">iqce2027 Fundamentals</span>
