...
const DEFAULTS = {
    title: 'International Quantum Computing & Engineering Summit',
    description: 'The premier gathering for experts in quantum computing, turbulence mechanisms, and advanced engineering.',
    date: 'December 14-16, 2026',
    venue: 'Outram, Singapore',
    edition: 'OFFICIAL 2026 EDITION',
    brand: 'IQCES VORTEX SUMMIT 2026',
    features: [
        'Advance knowledge of Quantum-based rotation definitions.',
        'Solve complex turbulence mechanisms in fluid dynamics.',
        'Promote cross-disciplinary research in CFD and quantum computing.',
        'Implement AI-driven vortex detection frameworks.',
    ],
    themes: [
        'Quantum Fundamentals', 'Omega Method', 'Turbulence Structure Analysis',
        'Machine Learning in Fluids', 'Aerospace Application', 'Vortex Dynamics'
    ]
};
