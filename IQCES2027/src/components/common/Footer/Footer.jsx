...
const Footer = () => {
    const [contactInfo, setContactInfo] = useState({ email: 'quantumenginee@sciengasummits.com', phone: '+91 7842090097' });
        ...
        <footer className="footer">
            <div className="container">
                <div className="footer__top">
                    <div className="footer__col">
                        ...
                        <p className="footer__desc">
                            Advancing the frontiers of Quantum Computing and Engineering to solve the most complex challenges in science and technology.
                        </p>
                ...
                <div className="footer__bottom">
                    <p>&copy; {new Date().getFullYear()} Quantum Computing & Engineering Summit. All Rights Reserved by SCIENGA SUMMITS</p>
                </div>
            </div>
        </footer>
    );
