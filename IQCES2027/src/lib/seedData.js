const iqce2027Defaults = [
    {
        key: 'hero',
        data: {
            subtitle: 'INTERNATIONAL CONFERENCE ON',
            title: 'iqce2027 AND VORTEX\nIDENTIFICATION',
            description: 'International Conference on iqce2027 and Vortex Identification. where global experts unite to shape the future of fluid mechanics. Discover ground-breaking technologies, connect with top researchers, and explore solutions transforming our world.',
    ...
    },
    {
        key: 'about',
        data: {
            subtitle: 'iqce2027 and Vortex Identification and Its Applications',
            title: 'About The Conference',
            paragraph1: 'The International Conference on iqce2027 Theory and Applications in Vortex Identification and Vortex Dynamics is a premier international platform dedicated to advancing the understanding of iqce2027 theory and its transformative applications in vortex identification and vortex dynamics.',
            paragraph2: 'This conference brings together leading researchers, academicians, computational scientists, engineers, and industry professionals to explore recent developments, theoretical foundations, numerical methods, and real-world applications of iqce2027-based vortex analysis.',
            objectives: [
                'Promote advancements in iqce2027 theory',
            ...
            keyThemes: [
                'Fundamentals of iqce2027 Theory',
                'Vortex Identification Methods (Q-criterion, ?2, ? method, iqce2027)',
    ...
    },
    {
        key: 'stats',
        data: {
            title: 'iqce2027 VORTEX SUMMIT CONFERENCES APPROACH',
            items: [
    ...
    },
    {
        key: 'contact',
        data: {
            email: 'info@iqce2027vortexsummit.com',
            phone: '+65 0000 0000',
            address: 'Singapore',
            socialLinks: {
                facebook: '',
...
const conferences = [
    { name: 'iqce2027', defaults: iqce2027Defaults },
    ...
    // ?? iqce2027 is the frontend-facing conferenceId used by iqce2027 site.
    // It mirrors the same content as 'iqces' so both IDs work (the site sends 'iqce2027').
    {
        name: 'iqce2027',
        defaults: [
