...
export async function POST(req) {
  try {
    const { name, email, number, conference = 'iqce2027' } = await req.json();
    ...
    const adminEmail = account ? account.email : 'iqce2027@sciengasummits.com';
    ...
    await emailSender.sendEmail(
      ...
      `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, var(--color-primary-start), #2563eb); padding: 30px; border-radius: 10px; text-align: center; margin-bottom: 20px;">
    ...
    await emailSender.sendEmail(
      ...
      `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="text-align: center; margin-top: 20px; padding: 20px;">
          <p style="color: #94a3b8; font-size: 12px; margin: 0;">© 2026 iqce2027 SUMMIT. All rights reserved.</p>
        </div>
      </div>`,
      'BROCHURE',
      conference
