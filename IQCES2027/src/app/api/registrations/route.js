...
export async function GET(req) {
  try {
    ...
    const conf = searchParams.get('conference') || 'iqce2027';
...
export async function POST(req) {
  try {
    ...
    const { name, email, category, conference = 'iqce2027' } = body;
    ...
    const siteUrl = process.env.FRONTEND_URL || 'https://iqce2027vortexsummit.com';
