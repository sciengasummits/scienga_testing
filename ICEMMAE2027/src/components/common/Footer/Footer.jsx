...
const Footer = () => {
    const [contactInfo, setContactInfo] = useState({ email: 'contact@icemmae2027.com', phone: '+49 89 12345678' });
        ...
        <footer className="footer">
            <div className="container">
                <div className="footer__top">
                    <div className="footer__col">
                        ...
                        <p className="footer__desc">
                            Advancing the frontiers of mechanical, mechatronics, and aerospace engineering through innovation, collaboration, and cutting-edge research.
                        </p>
                ...
                <div className="footer__bottom">
                    <p>&copy; {new Date().getFullYear()} International Conference and Expo on Mechanical, Mechatronics and Aerospace Engineering. All Rights Reserved by SCIENGA SUMMITS</p>
                </div>
            </div>
        </footer>
    );
