...
const SITE_NAME = 'ICEMMA2027';
const BASE_URL = 'https://icemmae2027.sciengasummits.com';
const DEFAULT_IMAGE = `${BASE_URL}/og-image.png`;
const DEFAULT_DESC =
  'International Conference on Energy, Materials, Mechanical, Aerospace Engineering. February 2027 · Munich, Germany.';
    ...
    useEffect(() => {
        const apply = (dbData) => {
            ...
            const fullTitle = rawTitle
                ...
                : `${SITE_NAME} | International Conference on Energy, Materials, Mechanical, Aerospace Engineering – Munich, Germany`;
