                ...
                <div className="about__content">
                    ...
                    <div className="about__scroll-content">
                        <p className="about__text">
                            We are truly delighted to welcome you to the <strong>Annual International Conference on Polymers and Composite Materials</strong>, scheduled to take place from <strong>November 16-18, 2026</strong>, in the vibrant city of <strong>Amsterdam, Netherlands</strong>. This premier international conference brings together top minds from academia, industry, and research institutions to explore transformative innovations in polymer science, composite materials, and advanced manufacturing.
                        </p>
                        <p className="about__text">
                            The conference is designed to bridge the gap between cutting-edge research and practical applications, serving as a dynamic platform for collaboration, knowledge exchange, and future-focused thinking. The conference aims to accelerate progress across disciplines and foster impactful connections that will drive the future of materials science and composite engineering.
                        </p>
                        <p className="about__text">
                            Join us in <strong>Amsterdam</strong> for three impactful days of insight, innovation, and connection at the forefront of polymers and composite materials!
                        </p>
                        <p className="about__text">
                            Industry Excellence: Amsterdam is a hub for advanced materials research and innovation, with world-class research institutions and a thriving materials science ecosystem.
                        ...
                        <div className="about__objectives" style={{ marginTop: '2rem' }}>
                            ...
                            <ul style={{ listStyleType: 'disc', paddingLeft: '1.5rem', color: 'var(--color-text-body)' }}>
                                <li style={{ marginBottom: '0.5rem' }}><strong>Advance Global Knowledge Exchange:</strong> To facilitate a premier platform for researchers, industry leaders, and scientists to exchange groundbreaking ideas and research in polymer science and composite materials.</li>
                                <li style={{ marginBottom: '0.5rem' }}><strong>Foster Interdisciplinary Collaboration:</strong> To encourage cross-sector partnerships between academia, research institutions, and private industries for accelerating materials innovation.</li>
                                <li style={{ marginBottom: '0.5rem' }}><strong>Showcase Innovative Technologies:</strong> To present state-of-the-art technologies and methodologies in polymer processing, composite manufacturing, and advanced materials applications.</li>
                                <li style={{ marginBottom: '0.5rem' }}><strong>Promote Research Development:</strong> To discuss and formulate actionable research frameworks that support advancement in materials science and engineering.</li>
                                <li style={{ marginBottom: '0.5rem' }}><strong>Empower Future Leaders:</strong> To mentor and inspire young scientists and engineers through workshops, networking, and exposure to cutting-edge materials research.</li>
                            </ul>
                        </div>
                        ...
                        <div className="about__themes" style={{ marginTop: '2rem' }}>
                            ...
                            <ul style={{ listStyleType: 'disc', paddingLeft: '1.5rem', color: 'var(--color-text-body)', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '0.5rem' }}>
                                <li>Polymer Synthesis & Processing</li>
                                <li>Composite Materials & Manufacturing</li>
                                <li>Nanocomposites & Nanomaterials</li>
                                <li>Biodegradable & Sustainable Polymers</li>
                                <li>Advanced Fiber Reinforced Composites</li>
                                <li>Polymer Characterization Techniques</li>
                                <li>Smart & Functional Polymers</li>
                                <li>Polymer Recycling & Circular Economy</li>
                            </ul>
                        </div>
                    </div>
                </div>
