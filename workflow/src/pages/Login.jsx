...
import { User, Lock, Eye, EyeOff, Shield, AlertCircle, CheckCircle2 } from 'lucide-react';

const VALID_USERNAME = 'sciengasummits';
...
export default function Login({ onLogin }) {
  ...
  function handleUsernameSubmit(e) {
    ...
    if (username.trim().toLowerCase() !== VALID_USERNAME) {
    ...
    <div className="login-root">
      ...
      <div className="login-container">
        ...
        <div className="login-branding">
          ...
          <h1 className="login-brand-title">Scienga Summits</h1>
        ...
        <p className="login-footer-text">
          © 2025 Scienga Summits. All rights reserved.
        </p>
      </div>
