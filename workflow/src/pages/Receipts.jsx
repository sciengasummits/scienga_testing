...
/* ── Mock data (mirrors reference screenshots) ── */
const INITIAL_DATA = [
    {
        id: 1,
    ...
    },
    {
        ...
        details: 'ummsjerz@savba.sk\n+421905746553\nSlovak Republic\nKeynote Speaker · In-person Speaker Participation',
        price: 629,
                ...
                <div className="rcp-card">
                    ...
                    <div className="rcp-pagination-bar">
                        ...
                        <div className="rcp-pagination">
                            ...
                            {pageNums.map((n, i) =>
                                n === '…' ? (
                                    <span key={`ellipsis-${i}`} className="rcp-page-ellipsis">…</span>
                                ) : (
                                    <button
                                        key={n}
