...
/* ── Save / restore browser text-selection ── */
...
/* ── Simple toolbar button (reuses AboutConference CSS) ── */
...
export default function Accommodation() {
    ...
    return (
        <div className="ac2-page">
            ...
            {/* ══ Section 1 — Rich-text editor (uses AboutConference toolbar) ══ */}
            <div className="ac2-section-card">
                ...
                <div className="ac2-editor-body">
                    <div className="ac2-field-row">
                        ...
                        {/* ── Editor card — reuses AboutConference CSS classes ── */}
                        <div className="editor-card">

                            {/* ── Toolbar (exact same as AboutConference) ── */}
