    const RECCDefaults = [
        ...
        },
        {
            ...
            data: {
                ...
                description: 'A world-class conference venue in the heart of Munich, Germany, offering state-of-the-art facilities for an international academic conference.',
                images: [
    ...
    const fluidDefaults = [
        ...
        },
        {
            ...
            data: {
                ...
                name: 'Munich, Germany',
                address: 'Munich, Germany',
                description: 'A world-class conference venue in the heart of Munich, Germany, offering state-of-the-art facilities for an international engineering conference.',
                images: [
                    'https://images.unsplash.com/photo-1540575861501-7ad05823c93e?w=1920&q=80',
                    'https://images.unsplash.com/photo-1512470876302-972fad2aa9dd?w=1920&q=80',
                    'https://images.unsplash.com/photo-1511578314322-379afb476865?w=1920&q=80'
        ...
        },
        {
            ...
            data: {
                dates: [
                    ...
                    { month: 'DEC', day: '07', year: '2026', event: 'Conference Date', icon: 'Star', sub: 'December 07-09, Munich, Germany' }
                ]
            }
        },
        {
    ...
    const conferences = [
                ...
                },
                {
                    ...
                    data: {
                        dates: [
                            ...
                            { month: 'DEC', day: '07', year: '2027', event: 'Conference Date', icon: 'Star', sub: 'December 07-09, 2027, Munich, Germany' }
                        ]
                    }
                },
                {
        ...
        // It mirrors the same content as 'iqces' so both IDs work (the site sends 'iqces2026').
        {
            ...
            defaults: [
                ...
                { key: 'marquee', data: { title: 'Supporting Universities & Institutions', items: ['MIT', 'Caltech', 'ETH Zurich', 'University of Cambridge', 'Stanford University', 'IBM Quantum', 'Google Quantum AI', 'University of Waterloo', 'National University of Munich, Germany', 'University of Science and Technology of China'] } }
            ]
        }
    ];
