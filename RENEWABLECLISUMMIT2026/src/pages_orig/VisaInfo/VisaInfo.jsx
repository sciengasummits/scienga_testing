...
const DEFAULTS = {
    ...
    intro: 'The INTERNATIONAL CONFERENCE ON RENEWABLE ENERGY AND CLIMATE CHANGE welcomes speakers & delegates from all over the world. Below is essential visa-related information to assist with your travel planning.',
    sections: [
        {
            id: 'visa_need',
...
const VisaInfo = () => {
    usePageSEO({
        ...
        canonical: 'https://recc2027.sciengasummits.com/visa-info',
    });
