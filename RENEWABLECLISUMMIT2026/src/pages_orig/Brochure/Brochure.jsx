...
const DEFAULTS = {
    pdfUrl: '',
    title: 'International Conference on Renewable Energy Systems and Applications in Vortex Identification and Climate Action',
    description: 'Download the official conference brochure to get comprehensive information about the International Conference on Renewable Energy Systems and Applications in Vortex Identification and Climate Action. It serves as your complete guide to the event, featuring detailed schedules, speaker profiles, and venue information.',
...
const Brochure = () => {
    usePageSEO({
        ...
        canonical: 'https://recc2027.sciengasummits.com/brochure',
    });
                        ...
                        <div className="brochure-preview">
                            <div className="preview-card">
                                <div className="preview-header">
                                    <div className="preview-logo-placeholder">RECC 2027</div>
