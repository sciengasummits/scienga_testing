...
const Subscribe = () => {
    usePageSEO({
        title: 'Subscribe',
        description: 'Subscribe to get the latest updates and news from the RECC Summit 2027.',
        canonical: 'https://recc2027.sciengasummits.com/subscribe',
    });
                    ...
                    <div className="subscribe-form-wrapper">
                        {success ? (
                            <div className="subscribe-success">
                                ...
                                <p>Thank you for subscribing. You'll receive the latest updates and news from RECC Summit 2027.</p>
                            ...
                            <>
                                <div className="form-header">
                                    ...
                                    <p>Get the latest news and announcements from RECC Summit 2027.</p>
                                </div>
