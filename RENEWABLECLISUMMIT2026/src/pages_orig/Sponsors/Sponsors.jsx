...
const Sponsors = () => {
    usePageSEO({
        ...
        description: 'Sponsor RECC 2027 – Platinum, Gold, Silver, and Exhibitor packages available. Showcase your brand to global renewable energy researchers and engineers in Munich, Germany, March 2027.',
        canonical: 'https://recc2027.sciengasummits.com/sponsors',
    });
            ...
            <div className="container section-padding sponsorship-packages">
                ...
                <div className="sponsorship-info-box">
                    <div className="info-text">
                        ...
                        <p>
                            If you are interested in sponsoring this event, please write an email to: <strong>renewable@sciengasummits.com</strong>
                        </p>
                    </div>
