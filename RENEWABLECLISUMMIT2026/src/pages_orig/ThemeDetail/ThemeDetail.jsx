...
const ThemeDetail = () => {
    ...
    usePageSEO({
        ...
        description: theme
            ? `RENEWABLECLISUMMIT2026 session: ${theme.title}. ${theme.description} Topics include: ${(theme.topics || []).slice(0, 3).join(', ')}.`
            : 'RENEWABLECLISUMMIT2026 conference session on Liutex Theory, Vortex Dynamics, and CFD.',
