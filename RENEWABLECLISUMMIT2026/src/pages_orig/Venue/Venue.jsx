...
import marienplatzImg from '../../assets/images/marienplatz.png';
import englishGardenImg from '../../assets/images/english_garden.png';
import munichSkylineImg from '../../assets/images/munich_skyline.png';
import bmwMuseumImg from '../../assets/images/bmw_museum.png';
    ...
    const nearbyAttractions = [
        {
            name: 'Marienplatz',
            distance: '0.5 km',
            image: marienplatzImg
        },
        {
            name: 'English Garden',
            distance: '1.2 km',
            image: englishGardenImg
        },
        {
            name: 'BMW Museum',
            distance: '4.0 km',
                ...
                <div className="container">
                    <div className="about-city-content">
                            ...
                            {venueHtml ? (
                                ...
                                <>
                                    <p className="city-description">
                                        Munich is a global hub for science, innovation, and sustainable technology. Known for its
                                        historic architecture, world-class museums, and as a leader in environmental research, it offers a
                                        perfect blend of traditional Bavarian culture and high-tech progress.
                                    </p>
                                    <p className="city-description">
                                        As one of Europe's premier conference destinations, Munich provides
                                        state-of-the-art facilities and world-class infrastructure. The city's commitment to 
                                        renewable energy and climate action makes it the ideal host for RECC 2027.
                                    </p>
                                </>
                            )}
                        ...
                        <div className="about-city-image">
                            <img
                                src="https://th.bing.com/th/id/OIP.0EdssVDQ618fLVx7xF4lhAHaE8?w=249&h=150&c=6&o=7&dpr=1.3&pid=1.7&rm=3"
                                alt="Munich City Skyline"
                                style={{ borderRadius: '20px', boxShadow: '0 20px 40px rgba(0,0,0,0.2)', width: '100%', height: 'auto', display: 'block' }}
                                onError={(e) => {
                                    e.target.src = munichSkylineImg;
                                }}
                            />
                        </div>
                    </div>
