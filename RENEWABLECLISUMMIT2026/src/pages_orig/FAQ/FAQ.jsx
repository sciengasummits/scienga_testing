    ...
    categories: [
        {
            ...
            items: [
                {
                    question: 'How can I register for the INTERNATIONAL CONFERENCE ON RENEWABLE ENERGY AND CLIMATE CHANGE?',
                ...
                },
                {
                    ...
                    answer: 'Yes, we offer group discounts for groups larger than 5 attendees. Please contact our support team at renewable@sciengasummits.com for more details.',
                },
                {
...
const FAQ = () => {
    usePageSEO({
        ...
        canonical: 'https://recc2027.sciengasummits.com/faqs',
    });
