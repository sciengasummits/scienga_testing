        ...
        <section className="speakers section-padding" id="speakers">
            <div className="container">
                <div className="text-center mb-5">
                    ...
                    <h2 className="section-title">Conference Participants</h2>
                </div>
                    ...
                    <div className="modal-overlay" onClick={closeModal}>
                        <div className="modal-content" onClick={e => e.stopPropagation()}>
                            ...
                            <div className="modal-body">
                                ...
                                <p className="modal-desc">{selectedSpeaker.bio || "A distinguished expert in the field of optics, photonics, and laser technology, contributing significantly to research and innovation. With years of experience leading photonics initiatives and publishing groundbreaking studies, they have become a pivotal figure in advancing optical sciences globally. Their work focuses on innovative laser applications and improving technological outcomes through cutting-edge photonics research."}</p>
                            </div>
                        </div>
                    </div>
                )
