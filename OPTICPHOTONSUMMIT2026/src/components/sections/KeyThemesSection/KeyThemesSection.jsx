...
const sessionsData = [
    { title: "Laser Technology & Applications", icon: Zap },
    { title: "Fiber Optics & Communications", icon: Activity },
    { title: "Photonic Integrated Circuits", icon: Cpu },
    { title: "Quantum Optics & Photonics", icon: Lightbulb },
    { title: "Optical Sensing & Imaging", icon: BarChart },
    { title: "Biophotonics & Medical Optics", icon: Activity },
    { title: "Nonlinear Optics", icon: Zap },
    { title: "Ultrafast Photonics", icon: Flame },
    { title: "Optical Materials & Metamaterials", icon: Factory },
    { title: "Laser Spectroscopy", icon: Sun },
    { title: "Optical Design & Engineering", icon: Cpu },
    { title: "Holography & 3D Imaging", icon: Globe },
    { title: "Optical Microscopy", icon: BarChart },
    { title: "Laser Manufacturing & Processing", icon: Factory },
    { title: "Photovoltaics & Solar Cells", icon: Sun },
    { title: "Optical Coherence Tomography", icon: Activity },
    { title: "Laser Safety & Standards", icon: ShieldCheck },
    { title: "Optical Metrology", icon: BarChart },
    { title: "Adaptive Optics", icon: Lightbulb },
    { title: "Terahertz Photonics", icon: Zap },
    { title: "Optical Data Storage", icon: Battery },
    { title: "Laser Cooling & Trapping", icon: Thermometer },
    { title: "Optical Networks", icon: Globe },
    { title: "Nanophotonics", icon: Cpu },
    { title: "Optical Amplifiers", icon: Zap },
    { title: "Laser Diodes & LEDs", icon: Lightbulb },
    { title: "Optical Coatings", icon: Factory },
    { title: "Photonic Crystals", icon: Lightbulb },
    { title: "Optical Signal Processing", icon: Cpu },
    { title: "Future of Photonics", icon: Sun },
];
