...
const Venue = () => {
    ...
    const nearbyAttractions = [
        ...
        },
        {
            ...
            distance: '1.5 km',
            image: "https://images.unsplash.com/photo-1566127444979-b3d2b654e3b7?w=800&q=80"
        },
        {
            ...
            <section className="venue-cta section-padding" style={{ background: 'var(--color-primary-gradient)' }}>
                <div className="container text-center">
                    ...
                    <p className="cta-desc" style={{ color: 'rgba(255,255,255,0.9)', marginBottom: '2rem', maxWidth: '600px', margin: '0 auto 2rem' }}>
                        Secure your spot at the Annual International Conference on Optics, Photonics and Laser Technology and be part of this transformative event
                    </p>
