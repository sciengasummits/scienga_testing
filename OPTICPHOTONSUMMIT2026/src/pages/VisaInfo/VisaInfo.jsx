                ...
                <div className="container">
                    <div className="visa-content-wrapper">
                        ...
                        <p className="visa-intro-text">
                            The <strong>Annual International Conference on Optics, Photonics and Laser Technology</strong> welcomes speakers & delegates from all over the world.
                        ...
                        <div className="visa-info-block">
                            ...
                            <ul className="visa-list">
                                <li>
                                    <strong>Check if you require a visa to enter the Netherlands</strong> using the Netherlands Immigration Service (IND) website or your local Dutch Embassy.
                                </li>
                                <li>
                                ...
                                <li>
                                    All visitors must have a valid passport with at least 3 months validity beyond the intended stay.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="visa-info-block">
                            ...
                            <ul className="visa-list">
                                <li>
                                    <strong>Schengen Visa:</strong> This allows you to visit the Netherlands and other Schengen countries for tourism, business, or attending conferences for up to 90 days.
                                </li>
                                <li>
                                    <strong>Airport Transit Visa:</strong> Required for certain nationalities if transiting through a Dutch airport. Check the IND website for the list of countries.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="visa-info-block">
                            ...
                            <ul className="visa-list">
                                ...
                                <li>Letter of Invitation (provided by the Conference Committee upon registration).</li>
                            </ul>
                        </div>
