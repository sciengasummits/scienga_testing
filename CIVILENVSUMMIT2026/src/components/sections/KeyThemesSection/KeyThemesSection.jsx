...
const sessionsData = [
    { title: "Structural Analysis & Design", icon: Activity },
    { title: "Sustainable Urban Infrastructure", icon: Factory },
    { title: "Geotechnical Engineering", icon: Mountain },
    { title: "Environmental Fluid Mechanics", icon: Droplet },
    { title: "Earthquake Engineering", icon: Activity },
    { title: "Bridge & Tunnel Engineering", icon: Anchor },
    { title: "Smart City Technologies", icon: Cpu },
    { title: "Construction Materials & Management", icon: Factory },
    { title: "Hydrology & Water Resources", icon: CloudRain },
    { title: "Coastal & Offshore Engineering", icon: Anchor },
    { title: "Traffic & Transportation Systems", icon: Zap },
    { title: "Waste Management & Recycling", icon: Recycle },
    { title: "Renewable Energy in Construction", icon: Sun },
    { title: "Climate Change Adaptation", icon: Globe },
    { title: "Structural Health Monitoring", icon: Activity },
    { title: "Green Building Design", icon: TreeDeciduous },
    { title: "Soil Mechanics & Foundation", icon: Mountain },
    { title: "Water Quality & Treatment", icon: Droplet },
    { title: "Urban Planning & Development", icon: Factory },
    { title: "Computational Structural Mechanics", icon: Cpu },
    { title: "Environmental Policy & Risk", icon: ShieldCheck },
    { title: "Digital Twins in Infrastructure", icon: Cpu },
    { title: "Pavement Engineering", icon: Zap },
    { title: "Disaster Risk Reduction", icon: CloudRain },
    { title: "Hydraulics & River Engineering", icon: Droplet },
    { title: "Composite Materials", icon: Factory },
    { title: "BIM & Digital Construction", icon: Cpu },
    { title: "Environmental Impact Assessment", icon: Activity },
    { title: "Sustainable Mobility", icon: Zap },
    { title: "Future of Civil Engineering", icon: Lightbulb },
];
                                ...
                                {displaySessions.map((session, index) => {
                                    ...
                                    return (
                                        <li key={index} className="session-item-clean">
                                            <span className="sessions-icon-small">
                                                <Icon size={18} />
                                            </span>
                                            <span className="sessions-text">{session.title}</span>
                                        </li>
                                    );
                                })}
                            </ul>
