...
const Venue = () => {
    ...
    const nearbyAttractions = [
        ...
        },
        {
            ...
            distance: '0.2 km',
            image: "https://images.unsplash.com/photo-1549400263-2253013d7801?w=800&q=80"
        },
        {
            name: 'Merlion Park',
            distance: '1.5 km',
                    ...
                    <div className="about-city-content">
                        <div className="about-city-text">
                            ...
                            <p className="city-description">
                                ...
                                it seamlessly integrates high-tech infrastructure with lush greenery, providing a stunning backdrop
                                for international summits.
                            </p>
                            <p className="city-description">
                                Marina Bay, the heart of the city's modern evolution, offers world-class conference facilities,
                                luxury accommodations, and iconic landmarks. Its strategic location and advanced transportation
                                make it the ultimate choice for global engineering and environmental science discussions.
                            </p>
                        ...
                        <div className="about-city-image">
                            <img
                                src="https://images.unsplash.com/photo-1525596662741-e94ff9f26de1?w=800&q=80"
                                alt="Singapore City"
                            />
                        </div>
                    </div>
            ...
            <section className="venue-cta section-padding" style={{ background: 'var(--color-primary-gradient)' }}>
                <div className="container text-center">
                    ...
                    <p className="cta-desc" style={{ color: 'rgba(255,255,255,0.9)', marginBottom: '2rem', maxWidth: '600px', margin: '0 auto 2rem' }}>
                        Secure your spot at the Global Summit on Civil Structural and Environmental Science and be part of this transformative event
                    </p>
