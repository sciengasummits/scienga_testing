...
const DEFAULTS = {
    ...
    intro: 'The International Conference on Quantum Computing & Engineering (IQCES-2026) welcomes speakers & delegates from all over the world. Below is essential visa-related information to assist with your travel planning to Bern, Switzerland.',
    sections: [
        {
            id: 'visa_need',
            title: '1. Do You Need a Visa?',
            points: [
                'Check if you require a visa to enter Switzerland using the Swiss Embassy or Consulate website in your country.',
                'Nationals of many countries (including USA, UK, Canada, Australia, Japan, and most EU countries) may enter Switzerland for short-term visits without a visa.',
        ...
        },
        {
            ...
            points: [
                ...
                'Letter of Invitation (provided by the Conference Committee upon registration).',
            ],
        },
        {
            id: 'visa_invite',
    ...
    contactEmail: 'quantumengineering@sciengasummits.com',
            ...
            <section className="section-padding visa-text-section">
                <div className="container">
                    <div className="visa-content-wrapper">
                        ...
                        {data.note && (
                            <p className="visa-intro-text" style={{ marginTop: '1.5rem', background: 'rgba(0,0,0,0.04)', padding: '1rem', borderRadius: '8px', borderLeft: '4px solid var(--color-primary, #1e3a8a)' }}>
                        ...
                        {data.contactEmail && (
                            <p className="visa-intro-text" style={{ marginTop: '1rem' }}>
                                ...
                                <a href={`mailto:${data.contactEmail}`} style={{ color: 'var(--color-primary, #1e3a8a)', fontWeight: 600 }}>
                                    {data.contactEmail}
                                </a>
                            </p>
                        )}
