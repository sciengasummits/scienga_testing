    ...
    categories: [
        {
            ...
            items: [
                {
                    question: 'How can I register for the International Conference on Quantum Computing & Engineering (IQCES-2026)?',
            ...
            items: [
                {
                    ...
                    answer: 'The congress will be held in Bern, Switzerland. Detailed venue information and maps are available on the Venue page.',
                },
                {
