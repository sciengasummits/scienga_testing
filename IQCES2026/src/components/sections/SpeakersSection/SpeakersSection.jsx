                ...
                <div className="modal-overlay" onClick={closeModal}>
                    <div className="modal-content" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            ...
                            <p className="modal-desc">{selectedSpeaker.bio || "A distinguished expert in the field of quantum computing and engineering, contributing significantly to research and technological innovation."}</p>
                        </div>
                    </div>
                </div>
            )}
