        ...
        <footer className="footer">
            <div className="container">
                <div className="footer__top">
                    <div className="footer__col">
                        ...
                        <p className="footer__desc">
                            Global experts unite to shape the future of Quantum Computing.
                            Discover ground-breaking technologies and connect with top quantum professionals.
                        </p>
                ...
                <div className="footer__bottom">
                    <p>&copy; {new Date().getFullYear()} International Conference on Quantum Computing & Engineering (IQCES-2026). All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    );
